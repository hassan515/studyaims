...
class AgentCompanyInfo(models.Model):
    ...
    service_type =  models.CharField(max_length=250 , default= None , null=True)
    company_owner = models.CharField(max_length=250 , default= None)
    agent_whatsapp = models.CharField(max_length=250 , default= None)
    ...
    office_contact = models.CharField(max_length=250 , default= None)
    ...
    service_type =  models.CharField(max_length=250, default= None)
    language_classes =  models.CharField(max_length=250, default= None, blank = True, null=True)
    processing = models.CharField(max_length=250 , default= None, blank = True, null=True)
    program_specialist = models.CharField(max_length=250, default= None, blank = True, null=True)
    refusal_appeals = models.CharField(max_length=250, default= None, blank = True)
    scholarships_offered = models.CharField(max_length=250, default= None, blank = True)
    interview_preparation = models.CharField(max_length=250, default= None, blank = True)
    travel_and_health = models.CharField(max_length=250, default= None, blank = True)
    travel_arrangements = models.CharField(max_length=250, default= None, blank = True)

    visa_ratio = models.CharField(max_length=250, default= None, blank = True)
    experience = models.CharField(max_length=250, default= None, blank = True)
    ...
    number_of_counselors = models.CharField(max_length=250, default= None, blank = True)

    processing_fee = models.CharField(max_length = 250,choices= ProcessingFee ,default = ProcessingFee, blank =True)
    language_fee = models.CharField(max_length = 250,choices=LanguageFee, default = LanguageFee, blank=True,null=True,)
    refusal_fee = models.CharField(max_length = 250,choices=RefusalFee ,default = RefusalFee, blank=True,null=True,)
    Interview_fee = models.CharField(max_length = 250,choices=InterviewFee,  default = InterviewFee, blank=True,null=True,)
    scholarshipfee = models.CharField(max_length = 250,choices=ScholarshipFee, default = ScholarshipFee, blank=True,null=True,)
    def __str__(self):
        return self.user.username
